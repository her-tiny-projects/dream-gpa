...
language_index = {'grade_upload': ['### UPLOAD BẢNG ĐIỂM', '### UPLOAD YOUR TRANSCRIPT'],
                  ...
                  'template_error': ['File không đúng mẫu! Bạn kiểm tra xem file của mình có chứa các cột dữ liệu như mẫu dưới đây không nhé!', "Incorrect file format! Please make sure your file contains columns as the template below"],
